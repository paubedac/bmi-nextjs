    ...
    <nav className="bg-gray-800">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          {/*<!-- Mobile menu button-->*/}
          <MenuButton isOpen={openMobileMenu} openMenu={() => setOpenMobileMenu(!openMobileMenu)}/>
      ...
      {
        openMobileMenu && (
          <div className="sm:hidden absolute z-20 origin-top-left bg-gray-800 w-full" id="mobile-menu">
...
<nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
      <div className="flex lg:flex-1">
        <a href="/" className="-m-1.5 p-1.5">
          ...
          <Image width={20} height={20} className="h-8 w-auto" src="https://tailwindui.com/plus/img/logos/mark.svg?color=indigo&shade=600" alt="" />
        </a>
      </div>
      ...
      <div className="hidden lg:flex lg:gap-x-11">
        <a href="/calculator" className="text-sm font-semibold leading-6 text-gray-900">Calculator</a>
        <a href="/about" className="text-sm font-semibold leading-6 text-gray-900">About BMI</a>
      </div>
    </nav>
 */